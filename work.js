...
var _1BPmMW= function transform(databybatch,container,chart){
	...
	//console.log(d0,databybatch[d0]['meta']['id']);
		d3.html(lnk+databybatch[d0]['meta']['id'],function(fragment){
			...
			formatedData[d0]['meta']['fontweight']=(started[0][0])?'bold' :'normal';
			formatedData[d0]['meta']['stroke']=(area===localarea)?"lightGreen":"white";
